...
const FlagIcon = ({ code }) => (_jsx("img", { src: `https://flagcdn.com/24x18/${code}.png`, alt: code.toUpperCase(), className: "inline-block", onError: (e) => { e.target.style.display = 'none'; } }));
...
const ExchangeRateDisplay = ({ isAdmin = false, compact = false }) => {
    ...
    if (compact) {
        return (_jsxs("div", { className: "flex items-center gap-4 text-sm", children: [_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(FlagIcon, { code: "us" }), _jsx("span", { className: "text-gray-500", children: "\u2192" }), _jsx(FlagIcon, { code: "py" }), _jsx("span", { className: "text-gray-500", children: "Gs:" }), _jsx("span", { className: "font-semibold", children: gsRate.toLocaleString('es-PY') })] }), _jsxs("div", { className: "flex items-center gap-1", children: [_jsx(FlagIcon, { code: "us" }), _jsx("span", { className: "text-gray-500", children: "\u2192" }), _jsx(FlagIcon, { code: "ar" }), _jsx("span", { className: "text-gray-500", children: "$a:" }), _jsx("span", { className: "font-semibold", children: arsRate.toLocaleString('es-PY') })] }), loading && _jsx(RefreshCw, { size: 14, className: "animate-spin text-gray-400" })] }));
    }
